...
{
  uint8_t tempval = 0;
  //if((address>0xD000) && (address<0xef00)) {printhex(address);}
  tempval=RAMread(address);
  //if((address>=0xD000) && (address<=0xDfFF)) {printhex(address-0xd000);}
  return(tempval);
}
...
void write6502(uint16_t address, uint8_t valu) 
{
  // printhex(address);printhex(valu);
    if ((address>=0xD400)&(address<=0xD41C)){writeSid(address-0xd400,valu);}
    RAMwrite(address,valu); 
   // if((address>=0xD000) && (address<=0xDCFF)) {printhex(address);}
   // printhex(address);
...
void reset6502() {
    pc = 0x0200;
    write6502(0xFFFE,0xFF);
    write6502(0xFFFF,0xFF);
    a = 0;
    x = 0;
    y = 0;
    sp = 0xFD;
